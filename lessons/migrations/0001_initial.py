...
>>>>>>> 6133e914a7580ee8973bffaea0bde243080efd2b
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.IntegerField(blank=True, default=0, editable=False, validators=[django.core.validators.MaxValueValidator(10000), django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('IN', 'Student transfer money from out into their balance'), ('OUT', 'Student transfer money from balance into school account')], default='OUT', max_length=30)),
                ('invoice_reference_transaction', models.CharField(max_length=30, validators=[django.core.validators.RegexValidator(message='Reference number must all be number and consist of - in between followed by at least three numbers', regex='^\\d*\\d-\\d\\d\\d\\d*$')])),
